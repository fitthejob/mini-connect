import { CheckHoursOfOperationActionBuilder, CheckMetricDataActionBuilder, CompareActionBuilder, DisconnectParticipantActionBuilder, FlowBuilder, MessageParticipantActionBuilder, TransferContactToQueueActionBuilder, UpdateContactTargetQueueActionBuilder, equalsCondition, numberGreaterThanCondition, } from "../index.js";
...
const setWorkingQueue = new UpdateContactTargetQueueActionBuilder("SetWorkingQueue")
    ...
    .onError("Disconnect")
    .build();
const transferToQueue = new TransferContactToQueueActionBuilder("TransferContactToQueue")
    .next("Disconnect")
