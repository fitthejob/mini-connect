...
import { DisconnectParticipantActionBuilder, FlowBuilder, MessageParticipantActionBuilder, SetCustomerQueueFlowActionBuilder, TransferContactToQueueActionBuilder, UpdateContactTargetQueueActionBuilder, renderFlowCatalog, writeRenderedFlowCatalog, } from "../index.js";
export const stagedFlowCatalogExampleBindings = {
    queues: {
...
export const stagedFlowCatalogExample = [
    {
    ...
    },
    {
        ...
        description: "Example inbound flow that binds a working queue ARN and an inter-flow customer queue flow ARN.",
...
export function stageExampleFlowCatalog(environment = "dev", outputDir) {
    ...
    console.log(`Wrote ${result.artifacts.length} staged flow artifacts to ${resolvedOutputDir}`);
