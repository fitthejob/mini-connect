export type FlowActionType = "AssociateContactToCustomerProfile" | "AuthenticateParticipant" | "CheckOutboundCallStatus" | "CheckVoiceId" | "ConnectParticipantWithLexBot" | "CompleteOutboundCall" | "CreateCase" | "CreateCallbackContact" | "CreatePersistentContactAssociation" | "CreateCustomerProfile" | "CreateTask" | "CreateWisdomSession" | "CheckHoursOfOperation" | "CheckMetricData" | "Compare" | "DequeueContactAndTransferToQueue" | "DisconnectParticipant" | "DistributeByPercentage" | "EndFlowExecution" | "EndFlowModuleExecution" | "EvaluateDataTableValues" | "GetCase" | "GetCalculatedAttributesForCustomerProfile" | "LoadContactContent" | "GetCustomerProfile" | "GetCustomerProfileObject" | "GetParticipantInput" | "GetMetricData" | "InvokeLambdaFunction" | "InvokeFlowModule" | "MessageParticipant" | "MessageParticipantIteratively" | "Loop" | "ResumeContact" | "ShowView" | "StartOutboundChatContact" | "StartVoiceIdStream" | "TagContact" | "TransferContactToQueue" | "TransferToFlow" | "TransferContactToAgent" | "TransferParticipantToThirdParty" | "UnTagContact" | "UpsertDataTableValues" | "UpdateContactCallbackNumber" | "UpdateContactData" | "UpdateContactEventHooks" | "UpdateContactMediaProcessing" | "UpdateContactMediaStreamingBehavior" | "UpdatePreviousContactParticipantState" | "UpdateContactRecordingAndAnalyticsBehavior" | "UpdateContactRoutingBehavior" | "UpdateContactTargetQueue" | "UpdateContactTextToSpeechVoice" | "UpdateCase" | "UpdateFlowLoggingBehavior" | "UpdateRoutingCriteria" | "UpdateContactAttributes" | "UpdateFlowAttributes" | "UpdateCustomerProfile" | "UpdateContactRecordingBehavior" | "ListDataTableValues" | "Wait";
export type CheckMetricDataMetricType = "NumberOfAgentsAvailable" | "NumberOfAgentsStaffed" | "NumberOfAgentsOnline" | "OldestContactInQueueAgeSeconds" | "NumberOfContactsInQueue";
...
export type OutboundCallStatusOperand = "CallAnswered" | "VoicemailBeep" | "VoicemailNoBeep" | "NotDetected";
export type CheckVoiceIdOption = "enrollmentStatus" | "voiceAuthentication" | "fraudDetection";
export type PreviousContactParticipantState = "AgentOnHold" | "CustomerOnHold" | "OffHold";
...
export type StartOutboundChatSourceEndpointType = "CONNECT_PHONENUMBER_ARN";
export type StartOutboundChatDestinationEndpointType = "TELEPHONE_NUMBER";
export type StartOutboundChatContactSubtype = "connect:SMS";
export type PersistentContactRehydrationType = "ENTIRE_PAST_SESSION" | "FROM_SEGMENT";
...
export type ContactEventHookType = "AgentHold" | "AgentWhisper" | "CustomerHold" | "CustomerQueue" | "CustomerRemaining" | "CustomerWhisper" | "DefaultAgentUI" | "DisconnectAgentUI" | "PauseContact" | "ResumeContact";
...
export type FlowConditionOperator = "Equals" | "TextStartsWith" | "TextEndsWith" | "TextContains" | "NumberGreaterThan" | "NumberGreaterOrEqualTo" | "NumberLessThan" | "NumberLessOrEqualTo";
