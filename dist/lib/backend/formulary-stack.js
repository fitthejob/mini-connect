...
export class FormularyStack extends cdk.Stack {
    ...
    constructor(scope, id, props) {
        ...
        this.formularyLookupHandler = new lambda.Function(this, `FormularyLookupHandler-${props.envName}`, {
            runtime: lambda.Runtime.PYTHON_3_13,
            handler: "formulary_lookup.handler",
            code: lambda.Code.fromBucket(props.s3Stack.lambdaArtifactBucket, "formulary_lookup.zip", ssm.StringParameter.valueFromLookup(this, `/mini-connect/${props.envName}/lambdas/formulary_lookup/object_version`)),
        ...
        this.formularyLookupHandler.grantInvoke(new iam.ServicePrincipal("connect.amazonaws.com", {
            conditions: {
