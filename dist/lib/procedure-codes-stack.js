...
export class ProcedureCodesStack extends cdk.Stack {
    ...
    constructor(scope, id, props) {
        ...
        this.procedureLookupHandler = new lambda.Function(this, `ProcedureLookupHandler-${props.envName}`, {
            runtime: lambda.Runtime.PYTHON_3_13,
            handler: "procedure_lookup.handler",
            code: lambda.Code.fromBucket(props.s3Stack.lambdaArtifactBucket, "procedure_lookup.zip", ssm.StringParameter.valueFromLookup(this, `/mini-connect/${props.envName}/lambdas/procedure_lookup/object_version`)),
        ...
        this.procedureLookupHandler.grantInvoke(new iam.ServicePrincipal("connect.amazonaws.com", {
            conditions: {
