...
export class BillingStack extends cdk.Stack {
  readonly billingLookupHandler: lambda.Function;
  ...
  constructor(scope: Construct, id: string, props: BillingStackProps) {
    ...
    this.billingLookupHandler = new lambda.Function(
      this,
      `BillingLookupHandler-${props.envName}`,
      {
        ...
        code: lambda.Code.fromBucket(
          ...
          ssm.StringParameter.valueFromLookup(
            this,
            `/mini-connect/${props.envName}/lambdas/billing_lookup/object_version`,
          ),
        ),
    ...
    this.billingLookupHandler.grantInvoke(
