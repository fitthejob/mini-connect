...
interface ProvidersStackProps extends cdk.StackProps {
  envName: string;
  kmsStack: KmsStack;
  s3Stack: S3Stack;
...
export class ProvidersStack extends cdk.Stack {
  readonly providerLookupHandler: lambda.Function;

  constructor(scope: Construct, id: string, props: ProvidersStackProps) {
    ...
    this.providerLookupHandler = new lambda.Function(
      this,
      `ProviderLookupHandler-${props.envName}`,
      {
        ...
        code: lambda.Code.fromBucket(
          ...
          ssm.StringParameter.valueFromLookup(
            this,
            `/mini-connect/${props.envName}/lambdas/provider_lookup/object_version`,
          ),
        ),
    ...
    this.providerLookupHandler.grantInvoke(
