...
new ContactFlowsStack(app, "MiniConnect-ContactFlows", {
  ...
  claimsQueueArn:         connectQueuesStack.claimsQueueArn,
  billingQueueArn:        connectQueuesStack.billingQueueArn,
  pharmacyQueueArn:       connectQueuesStack.pharmacyQueueArn,
  providerQueueArn:       connectQueuesStack.providerQueueArn,
